...
# input
actor = sys.argv[6]
actionTime = int(sys.argv[7])
newProductName = sys.argv[8]
...
print str(nPrdCorAssi) + ',' + str(nPrdAssi) + ',' + str(nLogPrdCorAssi) + ',' + str(nLogPrdAssi) + ',' + str(cntMaxExp) + ',' + str(cntN) + ',' + str(cmtN) + ',' + '\"' + str(role) + '\"'
